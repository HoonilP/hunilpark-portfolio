...
<!-- v3.0 Interactive Portfolio -->
- [ ] /lab2 라우트에 미디어아트 스타일 3D 인터랙티브 포트폴리오 구축
- [ ] 스크롤 드리븐 애니메이션으로 콘텐츠 전환 및 스토리텔링
- [ ] Three.js/R3F 기반 3D 몰입형 요소 (미디어아트 느낌)
- [ ] Framer Motion 기반 모션 및 마이크로 인터랙션
- [ ] 기존 7섹션에 얽매이지 않는 자유로운 콘텐츠 구성
- [ ] 5개 프로젝트 상세를 인터랙티브 요소 안에서 표현 (별도 상세 페이지 불필요)
- [ ] 데스크톱 전용 (모바일 대응 불필요)
...
- ~~3D/복잡한 애니메이션~~ — v3.0에서 /lab2로 구현 예정
...
v1: 미니멀, 깔끔한 디자인.
v2: 콘텐츠 확장 (5개 프로젝트 + 실제 이미지).
v3: /lab2에서 미디어아트 스타일 인터랙티브 포트폴리오. 스크롤 드리븐 + 3D 몰입 + 모션 인터랙션 전부 활용. 데스크톱 전용.
...
| /lab2 별도 라우트로 인터랙티브 구현 | 기존 메인 사이트 보존하면서 새로운 인터랙티브 경험 추가 | — Pending |
| 데스크톱 전용 | 3D 성능 고려, 모바일 대응 불필요 | — Pending |

## Current Milestone: v3.0 Interactive Portfolio

**Goal:** /lab2에 미디어아트 스타일의 3D 인터랙티브 포트폴리오를 구축하여, 프론트엔드 역량을 사이트 자체로 증명한다.

**Target features:**
- 스크롤 드리븐 3D 씬 전환과 스토리텔링
- Three.js/R3F 기반 미디어아트 3D 요소
- Framer Motion 기반 모션 + 마이크로 인터랙션
- 자유로운 섹션 구성 (기존 7섹션 구조 탈피)
- 5개 프로젝트 상세를 인터랙티브 안에서 표현
- 데스크톱 전용
